...
function Profile() {
  ...
  const fetchAdminStats = async () => {
    try {
      ...
      const pendingLoans = loansRes.data.stats.byStatus.find(stat => stat._id === 'pending')?.count || 0;

      setStats({
        totalUsers: usersRes.data.stats.totalUsers,
        totalLoans: loansRes.data.stats.overall.totalLoans,
        totalTransactions: transactionsRes.data.stats.overall.totalTransactions,
    ...
    <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="bg-white shadow rounded-lg p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <dd className="text-2xl font-bold text-gray-900">{stats.totalLoans}</dd>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <dd className="text-2xl font-bold text-gray-900">{stats.totalTransactions}</dd>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <dd className="text-2xl font-bold text-gray-900">{stats.pendingApprovals}</dd>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <dl className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <dt className="text-sm font-medium text-gray-500">Administrative Access</dt>
            <dd className="text-sm">
